...
@Autonomous(name = "Curvey", group = "Examples")
public class Curvey extends OpMode {

    private Follower follower;
    private Timer pathTimer, actionTimer, opmodeTimer;

    private int pathState;
    private final Pose startPose = new Pose(62, 106, Math.toRadians(125)); // Start Pose of our robot.
    ...
    private final Pose MidCurve1 = new Pose(50, 98,Math.toRadians(180));
    ...
    public void buildPaths() {
        ...
        FirstUP = new Path(new BezierCurve(startPose, MidCurve1, pickup2Pose));
        FirstUP.setTangentHeadingInterpolation();
    ...
    scorePreload.setConstantInterpolation(startPose.getHeading()); */
     ...
     //           .addPath(new BezierCurve(scorePose, MidCurve1, pickup2Pose))
